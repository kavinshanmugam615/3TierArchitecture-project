# 3TierArchitecture-project Project Steps

![Architecture Diagram](3tier-Architecture.jpg)

## 1. Create a VPC with 6 Subnets
...
mysql -h db-3tier.c1swcca42u7y.ap-south-1.rds.amazonaws.com -P 3306 -u admin -p
...
curl http://10.0.135.127:5000/login
```
...
- Complete validation. The certificate status will change to Issued once validated.
